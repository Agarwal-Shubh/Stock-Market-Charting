...
function CompanyMenu(props) {
    ...
    return (
        <div className={classes.TabContainer}>
            ...
            <Typography variant="button" onClick={handleCompareCompany} className={classes.buttonFont} style={ props.compareCompanyActive ? {'color':'#3b4c58',opacity:1  } : {}}>Compare Company</Typography>
            <hr className={classes.lineStyle} />
                </div>
            </div>           
        </div>
