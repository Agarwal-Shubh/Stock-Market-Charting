...
function IpoMenu(props) {
    ...
    return (
        <div className={classes.TabContainer}>
            ...
            <Typography variant="button" onClick={handleViewIpo} className={classes.buttonFont} style={ props.viewIpoActive ? {'color':'#3b4c58',opacity:1 } : {}}>List of IPOs</Typography>
