...
import { addExchange, deleteExchange, editExchange } from '../../../redux/actions/exchangeActions';
...
function Form(props){
    ...
    const [id,setId] = useState(props.exchange?props.exchange.id:'');
    const [name,setName] = useState(props.exchange?props.exchange.name:'');
    const [remarks,setRemarks] = useState(props.exchange?props.exchange.remarks:'');
    const [brief,setBrief]= useState(props.exchange?props.exchange.brief:'');
